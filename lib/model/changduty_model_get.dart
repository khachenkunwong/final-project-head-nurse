...
GetChangDuty getChangDutyFromJson(String str) => GetChangDuty.fromJson(json.decode(str));
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        member1: json["member1"] == null ? null : Member.fromJson(json["member1"]),
        member2: json["member2"] == null ? null : Member.fromJson(json["member2"]),
        duty1: json["_duty1"] == null ? null : Duty.fromJson(json["_duty1"]),
        duty2: json["_duty2"] == null ? null : Duty.fromJson(json["_duty2"]),
        memberShift1: json["member_shift1"] == null ? null : List<MemberShift1>.from(json["member_shift1"].map((x) => MemberShift1.fromJson(x))),
        memberShift2: json["member_shift2"] == null ? null : List<MemberShift2>.from(json["member_shift2"].map((x) => MemberShift2.fromJson(x))),
        memberApprove: json["member_approve"] == null ? null : json["member_approve"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "member_shift1": memberShift1 == null ? null : List<dynamic>.from(memberShift1!.map((x) => x.toJson())),
        "member_shift2": memberShift2 == null ? null : List<dynamic>.from(memberShift2!.map((x) => x.toJson())),
